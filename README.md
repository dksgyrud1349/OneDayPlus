# 🎨 원데이플러스 (OneDayPlus)
> **질문지 기반 사용자 맞춤형 원데이 클래스 추천 및 통합 관리 플랫폼**

**원데이플러스**는 간단한 설문을 통해 사용자의 취향을 분석하고 가장 잘 어울리는 클래스를 연결하며, 예약부터 결제까지 한 번에 해결할 수 있는 **Spring 기반의 웹 서비스**입니다.
...
* **보안 및 권한**: **Spring Security**를 적용하여 사용자, 플러스, 관리자 간의 접근 권한을 분리.
